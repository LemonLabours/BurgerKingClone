        ...
        ZStack {
            ...
            ScrollView{
                VStack(spacing: 16) {
                    ...
                    VStack (spacing: 3){
                        HStack(spacing: 3){
                            Text("By proceeding, you accept our") .foregroundColor(Color.bkBrown)   .font(.caption2)
                            Button{

                            }label: {
                                Text("Terms of service ")
                                    .underline() .foregroundColor(Color.bkDarkBrown)  .flame(font: .regular, size: 10)
                            }

                        }
                        HStack(spacing: 3){
                            Text("and confirm that you have read our") .foregroundColor(Color.bkBrown).font(.caption2)
                            Button{
